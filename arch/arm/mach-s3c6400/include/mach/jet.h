 ...
 *
 *  Copyright: JetDroid project 2009
 *  Copyright:	Samsung Electronics Co.Ltd. 05, Jul, 2007
 *
...
#define CONFIG_JET_REV00			0x80	/* REV00 */
#define CONFIG_JET_REV01			0x81	/* REV01 */
#define CONFIG_JET_REV02			0x82	/* REV02 */
#define CONFIG_JET_REV03			0x83	/* REV03 */
#define CONFIG_JET_REV04			0x84	/* REV04 */
#define CONFIG_JET_REV05			0x85	/* REV05 */
#define CONFIG_JET_REV06			0x86	/* REV06 */
#define CONFIG_JET_REV07			0x87	/* REV07 */
#define CONFIG_JET_REV08			0x88	/* REV08 */
#define CONFIG_JET_REV09			0x89	/* REV09 */

#define CONFIG_JET_TEST_REV00	0x00	
#define CONFIG_JET_TEST_REV01	0x01	
#define CONFIG_JET_TEST_REV02	0x02	
#define CONFIG_JET_TEST_REV03	0x03	
...
#if (CONFIG_JET_REV == CONFIG_JET_TEST_REV00)
#include "jet_rev00.h"
#elif (CONFIG_JET_REV == CONFIG_JET_TEST_REV01)
#include "jet_rev01.h"
#elif (CONFIG_JET_REV == CONFIG_JET_TEST_REV02)
#include "jet_rev02.h"
#else
...
#if (CONFIG_JET_REV == CONFIG_JET_TEST_REV02)
