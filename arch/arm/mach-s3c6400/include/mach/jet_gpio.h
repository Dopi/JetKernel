...
#define GPIO_UART0_RXD				S3C64XX_GPA(0)  // UART0_RXD
#define GPIO_UART0_RXD_AF			2

#define GPIO_UART0_TXD				S3C64XX_GPA(1)  // UART0_TXD
#define GPIO_UART0_TXD_AF			2
...
#define GPIO_PDA_RXD_AF				2		// UART RXD[2]

#define GPIO_PDA_TXD				S3C64XX_GPB(1)  // AP_TXD
#define GPIO_PDA_TXD_AF				2		// UART TXD[2]

#define GPIO_I2C1_SCL				S3C64XX_GPB(2)  // CAM_SCL
#define GPIO_I2C1_SCL_AF			6		// I2C SCL[1]

#define GPIO_I2C1_SDA				S3C64XX_GPB(3)  // CAM_SDA
#define GPIO_I2C1_SDA_AF			6		// I2C SDA[1]

// S3C64XX_GPB(4)

#define GPIO_I2C0_SCL				S3C64XX_GPB(5)  // WHICH BUS ???
#define GPIO_I2C0_SCL_AF			2		// I2C SCL[0]

#define GPIO_I2C0_SDA				S3C64XX_GPB(6)  // WHICH BUS ???
#define GPIO_I2C0_SDA_AF			2		// I2C SDA[0]

/* S3C64XX_GPC(0) ~ S3C64XX_GPC(7) */

//#define GPIO_OJ_SPI_MISO			S3C64XX_GPC(0)
//#define GPIO_OJ_SPI_MISO_AF			0		// 0 = Input

//#define GPIO_OJ_SPI_CLK				S3C64XX_GPC(1)
//#define GPIO_OJ_SPI_CLK_AF			1		// 1 = Output

//#define GPIO_OJ_SPI_MOSI			S3C64XX_GPC(2)
//#define GPIO_OJ_SPI_MOSI_AF			1		// 1 = Output

//#define GPIO_OJ_CS				S3C64XX_GPC(3)
//#define GPIO_OJ_CS_AF				1		// 1 = Output
...
#define GPIO_WLAN_BT_SHUTDOWN			S3C64XX_GPD(1)	// BT_WLAN_REG_ON
#define GPIO_WLAN_BT_SHUTDOWN_AF		1		// 1 = Output
