...
//bss
#define GPIO_LUM_PWM	GPIO_BT_WAKE
#define GPIO_LUM_PWM_AF GPIO_BT_WAKE_AF        
...
#define GPIO_MSENSE_RST		S3C64XX_GPN(2)
#define GPIO_MSENSE_RST_AF		(2)
...
#define GPIO_PS_VOUT 		GPIO_REV_3
#define GPIO_PS_VOUT_AF		GPIO_REV_3_AF
