...
// 20081120 Bigbang
/* ioctl for  LM49350 */
#define    AUDIO_IOCTL_PLAY_PATH	0
#define    AUDIO_IOCTL_PHONE_PATH	1
#define    AUDIO_IOCTL_REC_PATH		2
#define    AUDIO_IOCTL_MIC_PATH		3
...
struct snd_soc_dai_ops {
	...
	// 20081120 Bigbang
	int (*set_mode)(struct snd_soc_dai *, struct snd_pcm_substream*, int);
	int (*ioctl)(struct snd_soc_dai *, int cmd, int arg1,int arg2);
