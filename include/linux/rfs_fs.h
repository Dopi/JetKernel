...
int rfs_fill_inode (struct inode *, struct inode *, struct rfs_dir_entry *, unsigned int, int, struct buffer_head*);
...
struct inode *rfs_iget(struct super_block *, struct inode *, unsigned long, 
		unsigned int, struct rfs_dir_entry *, struct buffer_head *);
