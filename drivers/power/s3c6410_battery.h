 ...
 *
 */
#define DRIVER_NAME	"infobowlq-battery"
...
#endif					
//not use #define REVISION_ADC_CHANNEL	7		/* Revision Resistor ADC */
...
#if defined(CONFIG_MACH_INFOBOWLQ) && defined __FUEL_GAUGES_IC_MAX17043__
#define RECHARGE_COND_VOLTAGE 4090	/* 4.13V */	
#define FULL_CHARGE_COND_VOLTAGE 4190	/* 4.19V */
#define EX_FULL_CHARGE_COND_VOLTAGE 4000	/* 4.05V */
#define FG_COMPER_COND_VOLTAGE 3550 /* 3.55V */
#endif

#ifdef __CHECK_BATTERY_V_F__
#define BATT_VF_MAX		50
#define BATT_VF_MIN		1
...
#if defined(CONFIG_MACH_INFOBOWLQ) && defined __FUEL_GAUGES_IC_MAX17043__ || defined(CONFIG_MACH_MAX)
#define CURRENT_OF_FULL_CHG  88	
#else
