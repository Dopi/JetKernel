...
static int s3c_i2c_clockrate(struct s3c_i2c *i2c, unsigned int *got)
{
	...
	freq = s3c_i2c_calcdivisor(clkin, target_frequency, &div1, &divs);
...
#ifdef CONFIG_PM
static int s3c_i2c_suspend(struct platform_device *dev,
				    pm_message_t msg)
{
