...
static int max8698_probe(struct i2c_client *client,const struct i2c_device_id *id)
{
	struct i2c_client *c;
	int ret = 0;
...
struct i2c_device_id MAX8698_id[] = {
	{ "max8698", 0},
	{ }
 };

MODULE_DEVICE_TABLE(i2c, MAX8998_id);
...
static struct i2c_driver max8698_driver = {
	...
	.probe = max8698_probe,
	.remove = __devexit_p(max8698_remove),
