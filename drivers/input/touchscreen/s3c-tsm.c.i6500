...
//static int pointercal[7]={20348, -207, -2681, 369, -26067, 7854, 65536};
//static int pointercal[7]={1, 1, 1, 1, 1, 1, 1};
...
/*
	...
	a= 0.0f;
	b= 0.0f;	
	float xtemp2 = (float) xtemp;
	float ytemp2 = (float) ytemp;
	a=(( z1 + x1*xtemp + y1*ytemp ) / s);	
	b=(( z2 + x2*xtemp + y2*ytemp ) / s);*/
	//x = (((( pointercal[2] + pointercal[0]*xtemp + pointercal[1]*ytemp ) / pointercal[6]) - 1350)*10/ 35);
	x = ((pointercal[2] + (pointercal[0]*xtemp * 10^7) + (pointercal[1]*ytemp* 10^7) ) / (pointercal[6]* 10^7));
	//printk("xtemp= %03ld \n",xtemp);

	//printk("x= %03ld \n",x);
	//printk("x/tscount= %03ld \n",x / ts->count);
	//y = (((( pointercal[5] + pointercal[3]*xtemp + pointercal[4]*ytemp ) / pointercal[6]) - 62119)*10 /35); 
	y = ((pointercal[5] + (pointercal[3]*xtemp * 10^7) + (pointercal[4]*ytemp * 10^7) ) / (pointercal[6] * 10^7));
	//printk("ytemp= %03ld \n",ytemp);
	//printk("y= %03ld \n",y);
	//printk("y/tscount= %03ld \n",y/ ts->count);
...
//	 input_report_abs(ts->dev, ABS_Y, y );
	input_report_abs(ts->dev, ABS_X, ((x/ ts->count)-400));//400
	 input_report_abs(ts->dev, ABS_Y, ((y/ ts->count) - 480));//480
