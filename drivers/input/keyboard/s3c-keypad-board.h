...
#if CONFIG_MACH_INSTINCTQ

#if CONFIG_JET_OPTION
...
struct s3c_keypad_extra s3c_keypad_extra[] = {
	{0x0000, NULL,  &special_key_instinctq_00_01[0], 2,   &gpio_key_instinctq_01[0] , 1, 0},
	{0x0010, NULL,  &special_key_instinctq_00_01[0], 2,   &gpio_key_instinctq_01[0] , 1, 0},
};
