...
#ifdef CONFIG_MACH_SPICA	/* Spica specific */
...
#ifdef CONFIG_MACH_INSTINCTQ	/* InstinctQ specufic */
...
#ifdef CONFIG_MACH_JET		/* Jet specific */
#define KEYPAD_COLUMNS	(4)	/* GPIO_KEYSENSE_0 ~ GPIO_KEYSENSE_3 */
#define KEYPAD_ROWS	(4)	/* GPIO_KEYSCAN_0 ~ GPIO_KEYSCAN_3 */
...
#ifdef CONFIG_MACH_JET	/* Jet specific */
struct s3c_keypad_special_key special_key_jet_00[] = {
	{0x08000000, 0x00000000, KEYCODE_FOCUS},
	{0x00040100, 0x00000000, KEYCODE_DUMPKEY},
};
 
struct s3c_keypad_gpio_key gpio_key_jet_00[] = {
	{IRQ_EINT(5),  GPIO_POWER_N,      GPIO_POWER_N_AF,      KEYCODE_ENDCALL, 1},
	{IRQ_EINT(17), GPIO_HOLD_KEY_N,   GPIO_HOLD_KEY_N_AF,   KEYCODE_HOLDKEY, 1},
};
 
struct s3c_keypad_extra s3c_keypad_extra[] = {
	{0x0000, NULL, &special_key_jet_00[0], 2,  &gpio_key_jet_00[0], 1, 1},
	{0x0010, NULL, &special_key_jet_00[0], 2,  &gpio_key_jet_00[0], 1, 1},
};
#endif // #ifdef CONFIG_MACH_JET
