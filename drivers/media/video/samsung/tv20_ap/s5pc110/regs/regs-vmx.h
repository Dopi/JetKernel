...
#define S5P_MXR_DST_SEL_TVOUT ~S5P_MXR_DST_SEL_HDMI
//
...
#define S5P_MXR_INTERLACE_MODE ~(S5P_MXR_PROGRESSVE_MODE) //mkh
...
// MIXER_VIDEO_CFG
//[mkh:
#define S5P_MXR_VP_YUV_LIMITER_ENABLE (1<<17)
#define S5P_MXR_VP_YUV_LIMITER_DISABLE (0<<17)
//]
